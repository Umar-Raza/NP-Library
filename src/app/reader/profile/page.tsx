...
export default function ReaderProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (avatarFile) {
        newAvatarUrl = await uploadTitlePage(avatarFile); // same Cloudinary helper
      }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-10">
      ...
      <div className="bg-base-100 border border-base-200 rounded-3xl shadow-sm overflow-hidden">
        <div className="h-28 sm:h-36 bg-gradient-to-r from-primary/70 via-primary/50 to-secondary/50 relative">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 text-center sm:text-left">
              <div className="relative">
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-base-100 p-1.5 shadow-md">
                  <div className="w-full h-full rounded-xl bg-primary text-primary-content font-bold text-3xl sm:text-4xl flex items-center justify-center uppercase overflow-hidden">
                    {displayAvatar ? (
                      <img
                        src={displayAvatar}
                        alt="Avatar"
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mt-1">
                  <span className="badge badge-primary badge-soft text-xs font-semibold gap-1 py-2 px-2.5">
                    <ShieldCheck size={12} /> Reader
                  </span>
